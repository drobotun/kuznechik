...
GOST_Kuz_Get_C()
{
    ...
    for (i = 0; i < 32; i++)
         kuznechik_l_transformation(iter_num[i], iter_C[i]);
}
...
kuznechik_expand_key(const uint8_t *key)
{
    ...
    for (i = 0; i < 4; i++)
    {
        kuznechik_f_transformation(iter_1, iter_2, iter_3, iter_4, iter_C[0 + 8 * i]);
        kuznechik_f_transformation(iter_3, iter_4, iter_1, iter_2, iter_C[1 + 8 * i]);
        kuznechik_f_transformation(iter_1, iter_2, iter_3, iter_4, iter_C[2 + 8 * i]);
        kuznechik_f_transformation(iter_3, iter_4, iter_1, iter_2, iter_C[3 + 8 * i]);
        kuznechik_f_transformation(iter_1, iter_2, iter_3, iter_4, iter_C[4 + 8 * i]);
        kuznechik_f_transformation(iter_3, iter_4, iter_1, iter_2, iter_C[5 + 8 * i]);
        kuznechik_f_transformation(iter_1, iter_2, iter_3, iter_4, iter_C[6 + 8 * i]);
        kuznechik_f_transformation(iter_3, iter_4, iter_1, iter_2, iter_C[7 + 8 * i]);
